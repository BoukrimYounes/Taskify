...
const InProgressHeader = ({ number }) => (
  <div className="flex justify-between items-center p-3  border-b border-main">
    <h1 className="font-bold text-gray-800 uppercase flex items-center gap-1">
      <TbProgressCheck size={22} className="text-amber-500" />
      in-progress
    </h1>
      ...
      <div className="group  relative w-full p-6 bg-white border border-slate-100 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 ">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            <span
              className={`px-4 py-1 bg-amber-200 text-amber-800 text-sm font-medium rounded-full`}
            >
              {status}
            </span>
            <span
...
function Inprogress() {
  const [tasks, setTasks] = useState([
    {
      ...
      description:
        "Finalize and present Q3 marketing strategy to client stakeholders. Include analytics report and campaign performance metrics.",
      date: "2024-03-20",
      status: "In-Progress",
      type: "Base",
      initials: ["C", "R", "L"],
    },
    {
      ...
      description:
        "Complete advanced React patterns course and implement learned concepts in side project. Target: 2 hours focused coding.",
      date: "2024-03-10",
      status: "In-Progress",
      type: "Feature",
      initials: ["D", "S", "G", "P", "M"],
    },
    {
      ...
      description:
        "Coordinate with cross-functional team to define next sprint goals and assign user story points for upcoming development cycle.",
      date: "2024-03-22",
      status: "In-Progress",
      type: "Bug",
      initials: ["T", "W", "J", "A"],
  ...
  return (
    <div className="h-[95vh] bg-white rounded-xl shadow-lg">
      <InProgressHeader number={tasks.length} />
