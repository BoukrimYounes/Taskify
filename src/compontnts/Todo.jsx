        ...
        <div className="space-y-4 ">
          ...
          <div className="flex justify-between items-center pt-4 border-t border-slate-100">
            <div className="text-sm font-medium text-slate-500">
              Assigned by{" "}
              <span className="text-purple-600">Younes Boukrim</span>
            </div>
            ...
            <form className="space-y-8">
              ...
              cursor-pointer appearance-none font-medium text-[#2a2a4a] "
                  >
                    ...
                    <option value="Done" className="flex items-center py-2">
                      Completed
                    </option>
                  </select>
  ...
  const [tasks, setTasks] = useState([
    {
      ...
      description:
        "Taskify is a user-friendly task management application designed to help individuals organize, prioritize, and track their daily tasks and projects efficiently.",
    ...
    },
    {
      ...
      description:
        "Implement dark mode theme for Taskify to improve user experience in low-light environments. Ensure proper contrast and accessibility compliance.",
      date: "2024-03-25",
      status: "To-Do",
      type: "Feature",
      initials: ["A", "B", "E"],
    },
    {
      ...
      description:
        "Resolve issue where users are unable to log in after multiple failed attempts. Implement proper error handling and session management.",
      date: "2024-03-26",
      status: "To-Do",
      type: "Bug",
      initials: ["F", "G", "J"],
    },
    {
      ...
      description:
        "Refactor the core architecture of Taskify to improve scalability and maintainability. Focus on modular design and clean code practices.",
      date: "2024-03-27",
      status: "To-Do",
      type: "Base",
      initials: ["L", "M", "N", "O"],
    ...
    {
      title: "Add Task Reminder Feature",
      description:
        "Implement a reminder system that notifies users of upcoming tasks via email and push notifications. Allow customizable reminder intervals.",
      date: "2024-03-28",
      status: "To-Do",
      type: "Feature",
      initials: ["P", "Q", "R", "S", "T"],
    },
    {
      ...
      description:
        "Resolve bug where tasks are not syncing properly with Google Calendar. Investigate API rate limits and improve error handling.",
      date: "2024-03-29",
      status: "To-Do",
      type: "Bug",
      initials: ["U", "V", "W", "X", "Y"],
    },
    {
      ...
      description:
        "Optimize Taskify's performance by reducing load times and improving database queries. Focus on reducing latency for large task lists.",
      date: "2024-03-30",
      status: "To-Do",
      type: "Base",
      initials: ["Z", "A", "B", "C", "D"],
