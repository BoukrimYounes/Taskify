      ...
      <div className="group  relative w-full p-6 bg-white border border-slate-100 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 ">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            <span
              className={`px-4 py-1 bg-green-200 text-green-800 text-sm font-medium rounded-full`}
            >
              {status}
            </span>
            <span
...
function Complated() {
  const [tasks, setTasks] = useState([
    {
      title: "API Integration for Taskify",
      description:
        "Integrate third-party calendar API to sync tasks with Google Calendar and Outlook. Ensure proper error handling and rate limiting.",
      date: "2024-03-25",
      status: "Completed",
      type: "Bug",
      initials: ["A", "E"],
    },
    {
      ...
      description:
        "Implement responsive design for Taskify mobile app. Ensure compatibility across iOS and Android devices with proper touch interactions.",
      date: "2024-03-28",
      status: "Completed",
      type: "Base",
      initials: ["F", "G", "H"],
  ...
  return (
    <div className="h-[95vh] bg-white rounded-xl shadow-lg">
      <CompletedHeader number={tasks.length} />
